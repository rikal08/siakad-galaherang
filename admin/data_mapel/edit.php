<?php 
$id = $_GET['id'];
$sql = mysqli_query($koneksi,"SELECT * FROM mapel WHERE id_mapel='$id'");
			...
			<div class="box-body">
				<form action="" method="post">
					...
					<div class="form-group">
						...
						<input type="" value="<?= $data['nama_mapel'] ?>" required placeholder="Mata Pelajaran" class="form-control" name="nama_mapel">
					</div>
					<div class="form-group">
						<label>KKM</label>
						<input type="" value="<?= $data['kkm'] ?>" required placeholder="KKM" class="form-control" name="kkm">
					</div>
...
if (isset($_POST['submit'])) {
	...
	$b = $_POST['kkm'];
	$c = $_POST['id_kelas'];
	$sql = mysqli_query($koneksi,"UPDATE mapel SET 
		nama_mapel='$a',
		kkm='$b'
